<x-app-layout>
  ...
  @php
  $subtasks = is_array($task->subtasks) ? $task->subtasks : (is_string($task->subtasks) ? json_decode($task->subtasks,
  true) : []);
        ...
        <div class="card-body">
          ...
          <div class="mt-3">
            ...
            <div class="d-flex flex-wrap gap-2">
              ...
              <img src="{{ $image->url }}" alt="Task image" class="img-thumbnail"
        ...
        <div class="col-md-6">
          <div class="card border-0 shadow-sm">
            <div class="card-body">
              ...
              <strong>{{ $task->creator?->name ?? 'N/A' }}</strong>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <form method="POST" action="{{ route('tasks.comments.store', $task) }}" class="mb-4">
            ...
            <div class="mb-3">
              ...
              <select id="user_id" name="user_id"
                class="form-select @error('user_id') is-invalid border-danger @enderror">
            ...
            <div class="mb-3">
              ...
              <textarea id="body" name="body" rows="3"
                class="form-control @error('body') is-invalid border-danger @enderror">{{ old('body') }}</textarea>
              @error('body')
              <div class="invalid-feedback d-block">{{ $message }}</div>
              @enderror
            </div>
